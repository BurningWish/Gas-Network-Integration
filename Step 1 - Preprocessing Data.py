...
cur.execute("alter table gas_pipes add column se_pid serial")
cur.execute("alter table gas_pipes drop column if exists pid")
cur.execute("alter table gas_pipes add column pid integer")
print("add column rid done")
cur.execute("update gas_pipes set pid = se_pid - 1")
